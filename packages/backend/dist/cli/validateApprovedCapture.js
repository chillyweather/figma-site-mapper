...
async function main() {
    ...
    const crawlResult = await runCrawler(firstCandidateUrl, "http://localhost:3006", 10, 1, undefined, 0, 1000, undefined, false, 0, false, true, true, false, true, projectId, undefined, undefined, undefined, candidateUrls);
