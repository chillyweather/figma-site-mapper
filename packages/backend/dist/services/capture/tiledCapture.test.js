...
describe("TiledCapture", () => {
    ...
    it("captures below-fold lazy content after scroll trigger", async () => {
        ...
        const midLoaded = await page.evaluate(() => document.getElementById("mid-section")?.getAttribute("data-loaded") === "true");
        const belowLoaded = await page.evaluate(() => document.getElementById("below-section")?.getAttribute("data-loaded") === "true");
