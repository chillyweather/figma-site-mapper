...
- \`mapping-context/\` - generated evidence layer for repo, Storybook, library, token sources, and read-only suggestions.
...
5. Review \`mapping-context/profile.json\`, \`mapping-context/suggestions.json\`, and any optional evidence summaries.
